...
## How to use?:
Before using, make sure that all of these requirements are already installed onto your python (ONLY do this if the script somehow doesn't install the liraries included below):
- **sys**
- **os**
- **typing**
- **re**
